...
public class MonoLibConfigCommand {
  ...
  public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
    ...
    var monolibComWithConfigSub = Commands.literal(Constants.MOD_ID).requires(source -> source.permissions().hasPermission(Permissions.COMMANDS_GAMEMASTER)).then(config);
